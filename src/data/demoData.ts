...
export const demoClients: ClientRow[] = [
  { id: uuid(1), name: "TechVentures S.A.", email: "contato@techventures.com", phone: "(11) 99999-0001", document: "12.345.678/0001-01", address: "Av. Paulista, 1000 - São Paulo/SP", status: "ativo", notes: "Cliente premium desde 2024", client_type_id: null, created_at: daysAgo(180), updated_at: daysAgo(2), import_batch_id: null },
  { id: uuid(2), name: "Nova Digital LTDA", email: "oi@novadigital.com.br", phone: "(21) 98888-0002", document: "23.456.789/0001-02", address: "R. da Quitanda, 50 - Rio de Janeiro/RJ", status: "ativo", notes: "Focado em e-commerce", client_type_id: null, created_at: daysAgo(120), updated_at: daysAgo(5), import_batch_id: null },
  { id: uuid(3), name: "Startup Labs", email: "hello@startuplabs.io", phone: "(11) 97777-0003", document: "34.567.890/0001-03", address: "R. Augusta, 2000 - São Paulo/SP", status: "ativo", notes: "Startup de EdTech", client_type_id: null, created_at: daysAgo(90), updated_at: daysAgo(1), import_batch_id: null },
  { id: uuid(4), name: "Innova Corp", email: "contato@innovacorp.com.br", phone: "(31) 96666-0004", document: "45.678.901/0001-04", address: "Av. Afonso Pena, 500 - BH/MG", status: "ativo", notes: "Consultoria empresarial", client_type_id: null, created_at: daysAgo(150), updated_at: daysAgo(10), import_batch_id: null },
  { id: uuid(5), name: "DigitalPlus Agência", email: "contato@digitalplus.com", phone: "(41) 95555-0005", document: "56.789.012/0001-05", address: "R. XV de Novembro, 100 - Curitiba/PR", status: "ativo", notes: "Parceiro estratégico", client_type_id: null, created_at: daysAgo(200), updated_at: daysAgo(3), import_batch_id: null },
  { id: uuid(6), name: "Agro Connect", email: "admin@agroconnect.com.br", phone: "(62) 94444-0006", document: "67.890.123/0001-06", address: "Av. Goiás, 800 - Goiânia/GO", status: "ativo", notes: "Agronegócio digital", client_type_id: null, created_at: daysAgo(60), updated_at: daysAgo(7), import_batch_id: null },
  { id: uuid(7), name: "Saúde Mais Clínicas", email: "marketing@saudemais.med.br", phone: "(11) 93333-0007", document: "78.901.234/0001-07", address: "R. Oscar Freire, 300 - São Paulo/SP", status: "ativo", notes: "Rede de clínicas", client_type_id: null, created_at: daysAgo(45), updated_at: daysAgo(1), import_batch_id: null },
  { id: uuid(8), name: "Escola Futuro", email: "contato@escolafuturo.edu.br", phone: "(85) 92222-0008", document: "89.012.345/0001-08", address: "Av. Beira Mar, 2500 - Fortaleza/CE", status: "inativo", notes: "Contrato encerrado em Fev/2026", client_type_id: null, created_at: daysAgo(300), updated_at: daysAgo(30), import_batch_id: null },
];

// ── Contracts ──
export const demoContracts: ContractRow[] = [
  { id: uuid(101), client_id: uuid(1), status: "ativo", value: 8500, start_date: daysAgo(180), end_date: daysFromNow(180), billing_frequency: "mensal", notes: "Contrato anual renovável", contract_type_id: null, plan_id: null, created_at: daysAgo(180), updated_at: daysAgo(2), clients: { name: "TechVentures S.A." }, plans: null, contract_types: null },
  { id: uuid(102), client_id: uuid(2), status: "ativo", value: 3200, start_date: daysAgo(120), end_date: daysFromNow(240), billing_frequency: "mensal", notes: null, contract_type_id: null, plan_id: null, created_at: daysAgo(120), updated_at: daysAgo(5), clients: { name: "Nova Digital LTDA" }, plans: null, contract_types: null },
  { id: uuid(103), client_id: uuid(3), status: "ativo", value: 15000, start_date: daysAgo(60), end_date: daysFromNow(30), notes: "Projeto pontual", contract_type_id: null, plan_id: null, created_at: daysAgo(60), updated_at: daysAgo(1), clients: { name: "Startup Labs" }, plans: null, contract_types: null },
  { id: uuid(104), client_id: uuid(4), status: "ativo", value: 5500, start_date: daysAgo(150), end_date: daysFromNow(210), billing_frequency: "mensal", notes: null, contract_type_id: null, plan_id: null, created_at: daysAgo(150), updated_at: daysAgo(10), clients: { name: "Innova Corp" }, plans: null, contract_types: null },
  { id: uuid(105), client_id: uuid(5), status: "ativo", value: 4000, start_date: daysAgo(200), end_date: daysFromNow(160), billing_frequency: "mensal", notes: null, contract_type_id: null, plan_id: null, created_at: daysAgo(200), updated_at: daysAgo(3), clients: { name: "DigitalPlus Agência" }, plans: null, contract_types: null },
  { id: uuid(106), client_id: uuid(6), status: "ativo", value: 2800, start_date: daysAgo(60), end_date: daysFromNow(300), billing_frequency: "mensal", notes: null, contract_type_id: null, plan_id: null, created_at: daysAgo(60), updated_at: daysAgo(7), clients: { name: "Agro Connect" }, plans: null, contract_types: null },
  { id: uuid(107), client_id: uuid(7), status: "ativo", value: 6000, start_date: daysAgo(45), end_date: daysFromNow(315), billing_frequency: "mensal", notes: null, contract_type_id: null, plan_id: null, created_at: daysAgo(45), updated_at: daysAgo(1), clients: { name: "Saúde Mais Clínicas" }, plans: null, contract_types: null },
  { id: uuid(108), client_id: uuid(8), status: "encerrado", value: 12000, start_date: daysAgo(300), end_date: daysAgo(30), notes: "Projeto concluído", contract_type_id: null, plan_id: null, created_at: daysAgo(300), updated_at: daysAgo(30), clients: { name: "Escola Futuro" }, plans: null, contract_types: null },
];
